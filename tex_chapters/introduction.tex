...
of the invasion approximately 14600 civilians have died and the total number of people who lost their lives is approximately of 2 millions as of \textcite{jonesrussia}. This war has been particularly historical
because has been
the first major conflict between two different european states since the end of the Second World War,
 as the war in Iugoslavia is considered to be a civil conflict which led to the intervention of external states.\\
...
which allows to understand the major topics which are discussed in the society regarding the war 
...
for automatically analysing the argumentation in these controversies, as a first passage which will allow in the future 
...
\end{itemize}
The output of these tasks are usually used to produce an argument graph where the components are the vertices and the relation are the edges.
